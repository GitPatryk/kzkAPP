...
class MainViewModel with ChangeNotifier {
  ...
  List<ModeItemModel> nodes = const [
    ...
    ModeItemModel(
      ...
      minutes: 0,
      seconds: 10,
      color: Color.fromARGB(255, 113, 81, 59),
    ),
  ];
  ...
  runOrPause() {
    ...
    if (modeStatus == ModeStatus.running) {
      ...
      timerVM.start(Duration(seconds: selectedMode!.seconds));
      ...
      Timer.periodic(
        ...
        washingMachineController.setAngularVelocity(-8.0,
            seconds: selectedMode!.seconds, stopAtEnd: true);
      });
    }
  ...
  selectMode(ModeItemModel mode) {
    ...
    ServiceLocator.get<WashingMachineController>()
        .setAngularVelocity(9.0 * sign, stopAtEnd: true, seconds: 1);
  }
}
